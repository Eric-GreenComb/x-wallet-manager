<template>
  <div>
    ...
    <div class="page-content">
      <common-header-tilte :title2="'抢购'"></common-header-tilte>
      ...
      <el-table :data="tableData" max-height="500" style="width: 100%;" border v-loading="loading">
        ...
        <el-table-column prop="pics" label="商品图片" style="text-align: center;" min-width="120">
          <template slot-scope="scope">
            <img :src="scope.row.pics" class="table_pic"/>
          </template>
        </el-table-column>
        <el-table-column prop="start_time" label="开始时间" min-width="180" format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd HH:mm:ss"></el-table-column>
        <el-table-column prop="end_time" label="结束时间" min-width="180" format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd HH:mm:ss"> </el-table-column>
        ...
        <el-table-column label="操作" min-width="300">
          ...
          <template slot-scope="scope" >
            ...
            <el-button v-if="scope.row.is_show == 0" style="margin: 0px 5px 5px" @click="editMoneyRow(scope.row.goods_id)" type="primary" size="mini">编辑价格</el-button>
            <el-button v-if="scope.row.is_show == 1" disabled style="margin: 0px 5px 5px" @click="editMoneyRow(scope.row.goods_id)" type="primary" size="mini">编辑价格</el-button>
            <el-button v-if="scope.row.is_show == 0" style="margin: 0px 5px 5px" @click="editSizeRow(scope.row.goods_id)" type="primary" size="mini">编辑规格</el-button>
            <el-button v-if="scope.row.is_show == 1" disabled style="margin: 0px 5px 5px" @click="editSizeRow(scope.row.goods_id)" type="primary" size="mini">编辑规格</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      add () {
        this.$router.push({name: 'addRush', query: {title: '添加', id: 0}})
      },
      editRow (id) {
//        this.$router.push({name: 'addRush', query: {title: '编辑', id: id}})
