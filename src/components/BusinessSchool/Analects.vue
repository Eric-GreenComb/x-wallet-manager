<template>
  <div>
    ...
    <div class="page-content">
      <common-header-tilte :title2="'论语'"></common-header-tilte>
...
/*    handleSizeChange (val) {
    ...
    add () {
      this.$router.push({name: 'addnew', query: {title: '新建论语', id: 0}})
    },
    editRow (id) {
//      this.$router.push({name: 'addnew', query: {title: '编辑论语', id: id}})
      const {href} = this.$router.resolve({
        name: 'addnew',
        query: {
          title: '编辑论语',
